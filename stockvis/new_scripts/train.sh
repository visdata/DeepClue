...
../cnn/stock_vis/StockHierAvgSamplingFinetuneTfIdfResReg $outputdir/GSPC.tok $workspace/news.word.vec $workspace/data_new3/GSPC.train.clean.csv $workspace/data_new3/GSPC.dev.clean.csv
