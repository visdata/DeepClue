...
../cnn/stock_vis/StockHierAvgSamplingFinetuneTfIdfRes $outputdir/GSPC.tok $workspace/data_new2/bloomberg.50.clean.pretrained.vec $workspace/data_new2/GSPC.train.clean.csv $workspace/data_new2/GSPC.dev.clean.csv
